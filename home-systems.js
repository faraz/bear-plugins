...
(function () {
  ...
  function extractResearchItems(doc) {
    ...
    cards.forEach(function (card, index) {
      ...
      var stateLabel = metaSpans[1] ? text(metaSpans[1]) : text(card.querySelector(".research-card__status"));
  ...
  function renderItem(item) {
    ...
    if (item.sourceLabel) {
      ...
      badge.className = "systems-stream__badge systems-stream__badge--source";
    ...
    if (item.stateLabel) {
      ...
      state.className = "systems-stream__badge systems-stream__badge--state";
